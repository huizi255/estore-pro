...
<!--文件体开始-->
		...
		<tr>
         ...
         <c:forEach var="b" items="${listAllBooks}">       
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${b.id }</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp">${b.name}</a></td>
			<td class=tablebody2 valign=middle align=center width="">${b.price}</td>
			<td class=tablebody1 valign=middle align=center width=""><a href="shopcartServlet?id=${b.id }">
