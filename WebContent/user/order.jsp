...
<!--文件体开始-->
        ...
        <c:forEach var="o" items="${order}" varStatus="num">       
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${num.count}</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/orderinfo.info?orderid=${o.id}">${o.id}</a></td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${o.cost}</td>
			<td class=tablebody1 valign=middle align=center width="">${msg}</td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${payway}</td>
			<td class=tablebody1 valign=middle align=center width="">
			<input type="button" value="删除" onclick="javascript:window.location='removeOrder?orderid=${o.id}';">&nbsp;<input type="button" value="明细" onclick="javascript:window.location='orderInfo?orderid=${o.id}';"><!--&nbsp;<input type="button" value="修改"/>--> </td>
		</tr>
		</c:forEach>
