...
<!--文件尾开始-->
		...
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${l.book.id}</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=${l.book.id}" target="_blank">${l.book.name}</a></td>
			<td class=tablebody2 valign=middle align=center width="">价格：${l.book.price}</td>
			<td class=tablebody1 valign=middle align=center width="">数量：${l.num}</td>
			<td class=tablebody2 valign=middle align=left width="">小计：${l.book.price*l.num}</td>
		</tr>
		</c:forEach>
